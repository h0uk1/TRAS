...
<form action="ExhibitListAdmin" method="post" name="exhibitList">
	<input type="radio" name="exhibitList" value="exhibitList" checked="checked">出品中
	<input type="radio" name="exhibitList" value="exhibitEndList" onClick="submit()">出品終了
</form>
	...
	for(ExhibitInfo ei:userExhibitList){
	    out.println("<div class=\"container\">");
	        out.println("<div class=\"row jumbotron\">");
	            ...
	            //out.print("<a class=\"btn btn-lg btn-primary\" href=\"/kenta/ExhibitDeleteAdmin?action="+ ei.getExhibitID()+"\" role=\"button\">削除 &raquo;</a>");
